...
import { driverLoginAction } from "@/app/driver/login/actions";

export default function DriverLoginForm() {
  const [state, action, pending] = useActionState(driverLoginAction, { error: null });
      ...
      <div className="w-full max-w-[420px]">
        ...
        <div className="bg-white rounded-2xl border border-[#e2efed] shadow-[0_4px_24px_rgba(0,0,0,0.06)] p-8">
          ...
          <form action={action} className="space-y-5">
            <div>
              <label htmlFor="email" className="block text-xs font-semibold text-[#0d1f1c] uppercase tracking-wide mb-1.5">
                Email address
              </label>
            ...
            <div>
              <label htmlFor="password" className="block text-xs font-semibold text-[#0d1f1c] uppercase tracking-wide mb-1.5">
                Password
              </label>
              <div className="relative">
        ...
        <p className="text-center text-sm text-[#6b8280] mt-6">
          ...
          <Link href="/driver/signup" className="text-[#2a9d8f] font-semibold hover:underline no-underline">
            Apply to drive
          </Link>
        </p>
