          ...
          <div className="flex flex-wrap items-center gap-3 mb-6">
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="px-3 py-2 rounded-xl border border-[#e2efed] text-xs text-[#0d1f1c] bg-white focus:outline-none focus:border-[#2a9d8f] transition-colors"
              >
            ...
            <div className="flex items-center gap-2">
              <Languages className="w-3.5 h-3.5 text-[#2a9d8f] shrink-0" />
              <select
                value={langFilter}
            ...
            {hasActiveFilter && (
              <button
                ...
                className="flex items-center gap-1 text-xs font-semibold text-[#6b8280] hover:text-red-500 transition-colors"
              >
