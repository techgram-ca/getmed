...
const PAGE_SIZE = 10;
const STATUS_FILTERS = ["all", "new", "processing", "ready", "completed"] as const;
...
export default async function PharmacyOrdersPage({
  ...
  const summaryCards = [
    ...
    { label: "Delivered", value: completedCount ?? 0 },
  ];
                ...
                <table className="min-w-full">
                  <thead>
                    <tr className="bg-[#f8fffe] text-left">
                      ...
                      <th className="px-5 py-3 text-xs font-semibold text-[#6b8280]">Action</th>
                    </tr>
                  </thead>
